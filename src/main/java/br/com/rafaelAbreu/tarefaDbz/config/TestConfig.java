...
public class TestConfig implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		Tarefa t1 = new Tarefa(null,"Encontrar as Esferas do Dragão",TarefaStatus.EM_ANDAMENTO , Nivel.FACIL, u1);
		Tarefa t2 = new Tarefa(null,"Treinar com Mestre Kame",TarefaStatus.EM_ANDAMENTO , Nivel.FACIL, u3);
		Tarefa t3 = new Tarefa(null,"Combate",TarefaStatus.PENDENTE , Nivel.FACIL, u2);
		Tarefa t4 = new Tarefa(null, "Treinar para o Torneio do Poder", TarefaStatus.EM_ANDAMENTO, Nivel.FACIL, u2);
		Tarefa t5 = new Tarefa(null, "Proteger a Terra das ameaças de Freeza", null, Nivel.FACIL, null);
		Tarefa t6 = new Tarefa(null, "Encontrar as Dragon Balls para ressuscitar os amigos mortos", null, Nivel.FACIL, null);

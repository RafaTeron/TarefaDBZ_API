...
public class TestConfig implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		Tarefa t4 = new Tarefa(null, "Treinar para o Torneio do Poder", null);
		Tarefa t5 = new Tarefa(null, "Proteger a Terra das ameaças de Freeza", null);
		Tarefa t6 = new Tarefa(null, "Encontrar as Dragon Balls para ressuscitar os amigos mortos", null);
